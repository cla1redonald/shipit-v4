...
| `runtime-smoke-test.sh` (+ `ui-smoke.mjs`) | post-deploy: hits the **live** artifact — HTTP non-5xx + the page actually **renders** (Playwright) + an optional E2E suite; `[no-smoke]` | ✅ |
